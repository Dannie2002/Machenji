...
const LandingPage = () => {
  ...
  return (
    <section className='lg:min-h-[90vh] min-h-[85vh] flex items-start justify-center flex-col relative z-0' style={bg} >
               ...
               <img src={Machenji_ticket} alt="Tickets" className="absolute bottom-30 right-[30%] size-34 lg:size-84 object-cover opacity-40 z-50" />
    ...
    <div className="lg:px-22 px-6 z-50">
       ...
       <div className="flex  flex-col  items-start  justify-center space-y-6 ">
            <motion.h1 className="text-[14px] tracking-[10px] text-[#fffced] font-bold text-center leading-[16px]  lg:text-left lg:text-[10px] lg:leading-[14px]  uppercase"
            ...
            >
               Visit Machenji
                    ...
                    <p className=' text-left text-[18px] lg:w-[530px] z-50 text-[#a49f8c]'>Experience stress-free,, seamless event hosting where every detail—from setup to cleanup—is handled with professional precision. </p>
